...
def train(
    ...
    print_output_every_n_steps: int = 500,
    n_critic: int = 5,
):
    ...
    for i in range(training_steps):
        ...
        # print("converted env type to one shot vectors")
        ...
        if i % print_output_every_n_steps == 0:
            ...
            print("The number of non-zero allocations: ", count)
            ...
            if params['sim_env']:
                ...
                # print("generated rewards: ", generated_rewards)

            print("fake data average reward: ", generated_rewards.mean())
            writer.add_scalar('R' + '/fake_avg_reward', generated_rewards.mean(), i)

            print("real data average reward: ",true_avg_r)
            print("random sample average reward: ",true_raw_r)
